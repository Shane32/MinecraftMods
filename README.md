...
|------|-------------|-------------------|
| [Creepers Burn in Daylight](datapacks/creepers_burn_daylight/) | Makes creepers ignite when exposed to daylight, similar to zombies and skeletons. Runs once per second for lower server overhead. Works on vanilla or Fabric servers with no mods required. | 1.21 – 26.2 |
